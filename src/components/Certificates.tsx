      ...
      <div className="container mx-auto px-6 max-w-7xl">
                    ...
                    >
                      ...
                      <span className="ml-1.5 text-[10px] opacity-80 bg-black/20 px-1.5 py-0.5 rounded-full">
                        {platform === 'all'
                          ...
                          : completedCertificates.filter((cert) => getPlatform(cert) === platform)
                              .length}
                      </span>
                    </motion.button>
                  ))}
        ...
        >
          {certificates.map((certificate, index) => {
            ...
            return (
              <motion.div key={certificate.id || index} variants={itemVariants} className="group">
                <TiltCard intensity={5} spotlightColor="rgba(96,165,250,0.08)" className="h-full">
                  <div className="bg-gradient-to-b from-slate-800/40 to-slate-900/60 backdrop-blur-sm rounded-2xl border border-slate-700/30 hover:border-blue-400/40 transition-[border-color,box-shadow] duration-500 h-full flex flex-col overflow-hidden shadow-xl hover:shadow-2xl hover:shadow-blue-500/10">
                    ...
                    <div className="p-4 flex flex-col flex-1">
                      ...
                      {/* Issuer */}
                      {certificate.issuer &&
                        certificate.issuer !== (certificate.platform || certificate.provider) && (
                        ...
                        <div className="flex items-center gap-2 mb-3 text-slate-400 text-sm">
                          ...
                          <div className="flex flex-col">
                            <span className="font-semibold text-slate-300 text-xs">
                              {new Date(certificate.dateCompleted).toLocaleDateString('en-US', {
                                year: 'numeric',
                                month: 'short',
                                day: 'numeric',
                              })}
                      ...
                      <div className="mt-auto">
                          ...
                          <div className="pt-3 border-t border-slate-700/30 mb-3">
                            {certificateLink ? (
                              ...
                              >
                                ...
                                <span className="text-slate-400 font-mono group-hover/id:text-cyan-400 break-all text-[10px] bg-slate-900/30 px-1.5 py-0.5 rounded">
                                  {certificate.credentialId}
                                </span>
                              ...
                              <div className="flex items-center gap-1.5 text-xs">
                                <span className="text-slate-500 font-medium">ID:</span>
                                <span className="text-slate-400 font-mono break-all text-[10px] bg-slate-900/30 px-1.5 py-0.5 rounded">
                                  {certificate.credentialId}
                                </span>
                              </div>
                            )}
                        ...
                        {certificate.skills &&
                          ...
                          certificate.skills.length > 0 && (
                            <div
                              className={`${certificate.credentialId ? '' : 'pt-3 border-t border-slate-700/30'}`}
                            >
          ...
          >
            <div className="bg-slate-900/30 backdrop-blur-sm rounded-xl p-6 border border-slate-800/50 max-w-sm mx-auto">
              ...
              {completedCertificates.length === 0 ? (
                ...
                <>
                  <p className="text-base font-medium mb-2">No certificates found</p>
                  <p className="text-sm text-slate-500 mb-4">Try selecting a different platform</p>
                  <motion.button
