            ...
            <div className="bg-slate-800/50 backdrop-blur-sm border border-slate-700/50 rounded-2xl p-6 shadow-lg">
              ...
              <div className="space-y-4">
                {Object.keys(contactInformation).map((contactInfo: any, index: number) => {
                  const contactInfoData = contactInformation[
                    contactInfo as keyof typeof contactInformation
                  ] as any;
              ...
              <div className="mt-8 pt-6 border-t border-slate-700/50">
                ...
                <div className="flex gap-3">
                  {Object.keys(socials)
                    .filter((socialKey: any) => ['github', 'linkedin'].includes(socialKey))
                    .map((socialKey: any, index: number) => {
